...
const About=()=>{
    ...
    <div style={{padding:"0 10px"}}>
             <div className="About_Us">
                ...
                <p className="Set_A_Branch"> At <a  href="/" style={{color:"#fff"}}>Wegotips.com</a>, We set a benchmark of making provision of safe and accurate predictions you can trust! Wegotips predictions, tips & analysis are based on algorithms, detailed analysis, betting tips, forms and statistics. We have dedicated experts that are passionate in ensuring you make profits!</p>
...
<p className="Set_A_Branch">Our expers at <a  href="/" style={{color:"#fff"}}>Wegotips</a> offer predictions for various market. We are thorough in our work and have the success of our users in mind. We promise to aid you in your bets/trades! Wonder less we are considered the Home of Successful Predictions!</p>
                 </div>
             </div>
            </div>
                <div className="bkFR">
