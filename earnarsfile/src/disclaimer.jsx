        ...
        <div className="About_Dive_Page" >
         ...
         <div style={{padding:"0 10px"}}>
             <div className="About_Us">
                ...
                <p className="Set_A_Branch"> <a href="/" style={{color:"#fff"}}>Wegotips.com </a> is not a Forex Platform, bookmaker, betting and does not collect bets/trades. We provide predictions, techniques, guides, help and recommendations as we try to make them as accurate as possible and are subject to errors.</p>




<p className="Set_A_Branch">Predictions must be considered as recommendations and not incitement to bet/trade, Remember that trading in the financial market is very risky and gambling should be considered as entertainment. The visitor and <a  href="/" style={{color:"#fff"}}>Wegotips</a> user is solely responsible for his actions and his decisions and in no event shall the site and its employees be held responsible for the information included on Wegotips.</p>
<p className="Set_A_Branch"> will not be liable for any loss of money or anything else that may result from the use of the information on <a  href="/" style={{color:"#fff"}}>Wegotips</a>. Also please note that in some countries there are restrictions on sports betting/digital asset trading and it is the sole responsibility of the user/visitor to see and learn about these regulations. We reserve the right to discretion, without prior notice, to do changes and corrections to this site. The images, except where otherwise indicated, are taken directly from the web, if some images were inserted by mistake violating the copyright, please contact the administrator for immediate removal.</p>
<p className="Set_A_Branch"> By opting to receive predictions and tips, you accept that all earnars predictions and tips are for informational purposes only and that <a  href="/" style={{color:"#fff"}}>Wegotips</a> take no responsibility for any losses incurred by you the subscriber, as a direct result of acting upon received earnars information. We do not encourage gambling in any sort of form. Users under 18 years old must seek parental consent.</p>
                 </div>
             </div>
             </div>
             <div className="bkFR">
