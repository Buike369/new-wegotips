...
const success1 = ({succ}) => {
  return (
    <div>
        <div style={{position:"fixed",top:"0",right:"0",bottom:"0",left:"0",background:"#171054",zIndex:"50000"}}>
        ...
        <div style={{padding:"20px 20px",background:"#fff",width:"300px",borderRadius:"15px",boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px",display:"flex",justifyContent:'center',flexDirection:"column",alignItems:"center"}}>
            ...
            <p style={{color:"#000",fontSize:"18px",fontWeight:"600",textAlign:"center"}}>{succ}</p>
            </div>
        </div>
        </div>
    </div>
